...
I hope this is the most apt description of this package. [Chthulhu.jl](https://github.com/JuliaDebug/Cthulhu.jl). The descend function and
...
```
julia> Meta.@lower x .+= α .* r
:($(Expr(:thunk, CodeInfo(
    @ none within `top-level scope`
1 ─ %1 = Base.broadcasted(*, α, r)
│   %2 = Base.broadcasted(+, x, %1)
│   %3 = Base.materialize!(x, %2)
└──      return %3
))))
...
julia> bc1 = Broadcast.broadcasted(*, α, r)
